...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        SimpleOomage otherObj = (SimpleOomage) o;
        if (this.blue != otherObj.blue) {
            return false;
        }
        if (this.green != otherObj.green) {
            return false;
        }
        if (this.red != otherObj.red) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            int g = green / 5;
            int b = blue / 5;
            //The range of outcomes for each color is only 0 - 255 (8 bits)
            //Shift the red bits out of the way, shift the green bits out of
            //the way, leave the blue bits in place and OR all three together.
            return r << 16 | g << 8 | b;
        }
    }
